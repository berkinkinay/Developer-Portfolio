...
<div class="w-full h-fit flex items-center justify-center mt-24">
  <button
   class='flex lg:hidden absolute 3xl:left-[690px] 3xl:mt-6 2xl:mt-12 2xl:left-[500px]
          ...
          xl:absolute xl:left-[290px] text-white text-sm hover:animate-pulse hover:drop-shadow-lg'
   >
    <a 
     target="_blank"
     rel="noreferrer" 
        ...
        <div 
         ...
         >
          <div
           ...
           >
              <span
               class="before:block before:absolute before:-inset-3 before:-skew-x-12
           ...
           <div 
            class=
            'text-purple-500 text-semibold 3xl:text-lg 2xl:text-base'
           >

...
<div
 ...
 <div 
  class='flex h-screen 2xl:h-screen w-full bg-zinc-900 items-center 
        justify-center lg:h-[1820px] md:h-[1700px] md:w-[800px] sm:w-full sm:h-[2200px]'
  >
  <div 
   class=
  ...
  >
    ...
    <div 
     ...
     >
       ...
       <div 
        class='flex absolute z-10 h-fit w-36 mt-[68px] ml-[340px]
               text-lg md:ml-12 md:mt-[300px] items-center justify-center
               lg:ml-14 lg:mt-[70px] sm:ml-[70px] sm:mt-[360px]'
        > 
       <button 
       ...
       <button
         class="hover-2 text-base sm:text-2xl"
         onClick={ () => { 
             window.location.href='https://github.com/developedbyven/Developer-Portfolio'
             }}
         >
       ...
       <div 
        class='text-base flex absolute z-10 h-fit w-36 mt-[70px] ml-[620px]
               md:ml-12 md:mt-[860px] items-center justify-center lg:ml-14 lg:mt-[620px]
               sm:ml-[70px] sm:mt-[670px] sm:text-xl'>
       <button 
         class="hover-2 text-base sm:text-2xl"
         onClick={ () => { 
             window.location.href='https://github.com/developedbyven/Discord-clone'
             }}
         >
                Discord Clone
            <div class='sm:h-fit sm:w-fit sm:text-xl'>(in development)</div>
   ...
   <div class="flex absolute 3xl:bottom-14 2xl:bottom-0 items-center justify-center w-78 h-fit">
      <div 
       ...
       <a rel="noreferrer"  
          ...
          class="ml-1 mr-1 flex text-lg 2xl:text-base font-semibold 

  ...
  <div class="more-1">
    <div class='more-2'>              
     ...
     >
      ...
      >
       <p
        class='flex w-full text-slate-400 font-semibold text-xl 2xl:text-lg mt-5 uppercase
               xs:flex xs:mt-2 xs:mb-4 xs:indent-6 sm:flex sm:mt-2 sm:mb-4 sm:indent-6'
       >
